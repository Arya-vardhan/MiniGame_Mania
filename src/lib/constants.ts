...
export const truths: Record<string, string[]> = {
  ...
  friends: [
    ...
    "Who is the person in this room you trust the most?",
...
export const dares: Record<string, string[]> = {
  family: [
    ...
    'Imitate a family member until someone guesses who it is.',
  ...
  social: [
    ...
    'Attempt to juggle 3 items of the group\'s choosing.',
  ...
  naughty: [
    ...
    'Give a sensual massage to the person on your left for 1 minute.',
    'Do a 30-second lap dance for someone the group chooses.',
    'Kiss the cheek of the person across from you.',
    'Whisper something naughty into the ear of the person next to you.',
    'Remove one piece of clothing (keep it appropriate for the setting).',
